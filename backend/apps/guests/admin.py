...
from apps.guests.models import Guests, Songs, DonationMessajes, singleImages, formConfirmation
...
admin.site.register(singleImages)
admin.site.register(formConfirmation)
