...
from apps.guests.api.api import CommentDonationsAPIView, getSingleImagesAPIView
...
urlpatterns = [
    ...
    # path('single_guest/<phone_number>/', getSingleGuestAPIView.as_view(), name='single_guest'),
    ...
    path('singleImage/', getSingleImagesAPIView.as_view(), name='singleImage'),
